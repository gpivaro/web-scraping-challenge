...
def scrape():
    ...
    scrape_dict["Nasa title"] = news_title
    scrape_dict["Nasa par"] = news_p
    ...
    scrape_dict["JPL image"] = featured_image_url
    ...
    scrape_dict["Mars table"] = html_table
    ...
    scrape_dict["Mars Hemispheres"] = hemisphere_image_urls
